    ...
    <div class="mt-10 grid grid-cols-6 place-content-between gap-3" v-for="item in cart" :key="item.id">
        ...
        <div class="col-span-1 flex flex-col justify-center items-center">
            ...
            <div class="
                    ...
                    bg-stone-300
                    pointer-events-none
                " :class="getClass(item.qty)" @click="decrement(item.id, item.qty)">
                -
            </div>
        </div>
        <div class="col-span-6 flex justify-center text-red-500 cursor-pointer" title="Delete"
